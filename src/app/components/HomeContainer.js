...
const HomeContainer = () => {
  ...
  return (
    ...
    <button className='bg-purple-900 p-2 px-4 rounded-3xl w-fit m-auto my-4 text-[1.5em] lg:px-10 lg:text-2xl text-white shadow-green-950 shadow-2xs'>O sino buscá por Barrio! </button>
