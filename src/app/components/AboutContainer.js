...
const AboutContainer = () => {
  return (
    ...
    <section className='px-4 lg:px-10'>
        <h1 className='mb-4 text-[2.5em] text-center my-5 leading-9 font-black text-green-800'>Sobre VJ</h1>
      ...
      <Image
        ...
        <section className='px-4 lg:px-15  bg-green-800 text-white py-2 lg:p-10'>
            ...
            <ul className='flex flex-col lg:flex-row lg:justify-center gap-1 items-center py-2 font-semibold'>
                <li className='flex gap-1 text-[1.5em] lg:text-[1em]'><Image src={'/assets/ig.svg'} width={20} height={20} alt={"IG icon"}/>Instagram</li>
                <li className='flex gap-1 text-[1.5em] lg:text-[1em]'><Image src={'/assets/basket.svg'} width={20} height={20} alt={"Store icon"}/>Tienda Online</li>
            </ul>

            <p className='text-center leading-8 lg:leading-5 text-[1.30em] lg:text-[1em]'>Montserrat, nuestra fuente principal, es una tipografía inspirada en el diseño grafico del barrio porteño del mismo nombre. Elegimos esta fuente no solo por su estetica, sino tamben por su gran diversidad de grosores, haciendo que sea mucho mas customizable al usar.</p>
        </section>
        <section className='px-4 lg:px-10 lg:py-5'>
          <h2 className='text-[1.75em] lg:text-3xl text-center mt-2 leading-8 mb-2 lg:mb-4 font-semibold text-green-700'>Sobre la Autora</h2>
          <p className='text-center leading-8 lg:leading-5 text-[1.30em] lg:text-[1em] mb-3'>¡Buenas! Me llamo Victoria Mobilia, o sino me gusta el nombre Herbertia. Soy una chica dentro del Espectro Autista, y fui diagnosticada ¡Hace mas de diez años! Cuando era muy chica era mucho de salir, sea por miedo a la ciudad o aburrimiento, pero eso cambió despues de la pandemia del COVID. Buenos Aires tiene sus desperfectos, pero sin dudarlo es una ciudad magica. Belleza, historia y arte se esconden hasta en el más común de los barrios, y siempre hay algo para hacer sin importar el tiempo o la estación.</p>
