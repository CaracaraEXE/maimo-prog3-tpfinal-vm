...
const AlertaContainer = () => {
  return (
        <div className='px-4 py-5 lg:px-20'>
        <h1 className='text-[2.5em] text-center my-5 leading-9'>¡NO A LOS CUDS FALSOS!</h1>
        <p className='text-center leading-7 lg:leading-5 text-[1.30em] lg:text-[1em]'>Todos los beneficios mencionados en esta pagina son por y para <span className='font-bold'>personas con discapacidad. Vamos Juntos se opone totalmente a la falsificación de Certificados Únicos de Discapacidad a modo de obtener "ventajas" sobre otros.</span></p>

        <h2 className='text-[2em] lg:text-[1.5em] text-center leading-9 mt-5 mb-3'>¿Qué está pasando?</h2>
        <p className='text-center leading-7 lg:leading-5 text-[1.30em] lg:text-[1em] mb-5'>Desde el año 2019 se han estado reportando casos de gente falsificando este tipo de certificados, como por ejemplo 13 denunciados que colocaron el simbolo de discapacidad a modo de engañar sobre su condicion y obtener beneficios exclusivos.</p>
        <p className='text-center leading-7 lg:leading-5 text-[1.30em] lg:text-[1em] mb-5'>No obstante, esta problematica ha regresado con mas fuerza estos ultimos años, donde empresas de colectivos y choferes por igual han reportado incidentes con personas poseyentes de un CUD falso a modo de obtener un modo gratuito de trasnporte.</p>
        <p className='text-center leading-7 lg:leading-5 text-[1.30em] lg:text-[1em]'>Estas denuncias llevaron a una investigación a fondo, donde se descubrió una red de compra y venta ilegal de CUDs falsos en plataformas como Facebook Marketplace. También juega un lugar muy imporante la situación economica del pais, en donde el aumento del transporte publico ha hecho que mas personas usesn estos metodos de acceso a modo de acceso.</p>

        <h2 className='text-[2em] lg:text-[1.5em] text-center leading-9 mt-5 mb-3'>¿Por que es importante hablar de esto?</h2>
        <p className='text-center leading-7 lg:leading-5 text-[1.30em] lg:text-[1em] mb-5'>Las consecuencias de la falsificacion de CUDS AFECTA A LAS VERDADERAS PERSONAS CON DISCAPACIDAD. Por ejemplo, muchos colectivos están cambiando su forma de ofrecer el pase, haciendo que una persona discapactiada tenga que mostrar 2 documentos diferentes solamente para poder ingresar al vehículo, lo cual puede otorgar mas complejidad a la hora de viajar.</p>
        <p className='text-center leading-7 lg:leading-5 text-[1.30em] lg:text-[1em] mb-5'>Además, la falsificación de los Certificados Unicos de Discapacidad pueden afectar severamente el proceso de registro de los mismos, haciendo muy dificil poder conseguirlo para personas quienes lo necesiten.</p>
        <p className='text-center leading-7 lg:leading-5 text-[1.30em] lg:text-[1em]'>En la sociedad argentina, se ha estado circulando un sentimiento de "discapacidados falsos", que mientras puede tener fundamentos, su mal uso puede causar prejuicios muy negativos para los 1,3 millones de personas que poseen un CUD en la Argentina.</p>
        
        <section className='bg-red-800 rounded-3xl text-center p-8 lg:p-7 my-5'>
        ...
        <p className='text-center leading-7 lg:leading-5 text-[1.30em] lg:text-[1em] mb-5'>Al ser un problema reciente el cual parece que seguirá con el tiempo, lo mejor que se puede pedir es, sobre todas las cosas, <span className='font-bold'>denunciar la venta ilegal de estos certificados falsos, así como mantenerse siempre informado de las directivas sobre el CUD.</span></p>
        <p className='text-center leading-7 lg:leading-5 text-[1.30em] lg:text-[1em] mb-5'></p>
